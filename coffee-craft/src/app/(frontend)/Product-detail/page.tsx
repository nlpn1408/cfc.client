        ...
        <div className="col-span-5 col-start-2" >
          ...
          <div className=" flex items-center justify-center bg-gray-900">
            ...
            <div className="grid grid-cols-6 mt-10">
                <img className="col-span-2 h-40 border border-black-100 p-1 rounded-md" src={item.image2} />
                <img className="col-span-2 h-40 border border-black-100 p-1 rounded-md" src={item.image1} />
            </div>
          </div>
        </div>
