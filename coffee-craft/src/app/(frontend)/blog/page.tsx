...
const Blogs: React.FC = () => {
    ...
    const displayedBlogs = posts.slice(
    ...
    return(
        <div className="container">
            <div className="text-center">
                <h1 className="font-medium text-3xl p-5 my-10 pt-10">Blogs</h1>
            </div> 
            <div className="grid grid-cols-3 gap-x-6 gap-y-10">
            {displayedBlogs.map((items, index) => (
                <div key={index} className="border rounded-md">
                    <div>
                        <img className="w-full h-48 rounded-t-md mb-3" src={items.img} alt="" />
                    </div>
                    <div className="">
                        <div className="flex">
                            <img className="h-10 mx-3 rounded-full" src={items.authorLogo} alt="" />
                            <div>
                                <p className="text-sm">{items.authorName}</p>
