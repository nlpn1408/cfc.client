              ...
              <div className="relative">
                ...
                <div className="flex">
                  <input
                    ...
                    className="w-full pl-12 pr-3 py-2 text-gray-500 bg-white outline-none border focus:border-[#935027] shadow-sm rounded-l-md"
                  />
                  <button
                    type="submit"
                    disabled={loading}
                    className=" block w-auto py-2 px-4 font-medium text-sm text-center text-white bg-[#723E1E] hover:bg-[#935027] active:bg-[#935027] active:shadow-none rounded-r-md shadow"
                  >
